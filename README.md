...
running thread. You can choose a concrete number for the number of guests.


For both problems, I tested with different number of guests with number ranging from 2 to 100. 
In the final version, I kept the number of guests at 50. For problem 2, I used the strategy of 
having a sign that says wether the room is available or busy. When a thread enters the room, 
it sets the status to busy, looks at the vase, and then leaves the room and sets the status back to available.
